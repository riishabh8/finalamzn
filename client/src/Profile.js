  ...
  render() {
    return (
      <>
        ...
        <Navbar1 email={this.state.email} />
            ...
            <div className={"Home_mainDiv_flexDiv_ContentDiv"}>
              ...
              <Link to={"/plans"}>
                {!this.state.subscription && (
                  <button className="view--plan">View Plans</button>
                )}
              </Link>
              {this.state.subscription && (
                <button className="view--plan subscribed">Subscribed</button>
              )}
              <input
                className="view--plan"
                type="button"
              ...
              ></input>
              <p className={"Home_mainDiv_flexDiv_ContentDiv_p"}>
                Your current plan :{this.state.plan}
              </p>
            </div>
          </div>
